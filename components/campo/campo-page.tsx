    ...
    <div className="flex-1 flex flex-col">
      <header className="border-b bg-card">
        <div className="flex h-16 items-center justify-between px-6">
          <div>
            <h1 className="text-xl font-semibold">Gestión de Campo</h1>
            <p className="text-sm text-muted-foreground">Administra las tareas y actividades del campo - {user?.tenant?.name || 'Tu Empresa'}</p>
          </div>
