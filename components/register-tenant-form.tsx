    ...
    <div className="w-full max-w-2xl flex justify-center mx-auto">
      <Card className="w-full shadow-lg rounded-2xl border border-muted bg-white/90 px-10 py-10 flex flex-col justify-center" style={{ minWidth: 400, maxWidth: 600 }}>
        <CardContent className="w-full p-0">
          <h2 className="text-3xl font-bold mb-6 text-center text-primary">Registro de empresa</h2>
          <form className="space-y-3 w-full" onSubmit={handleSubmit}>
            ...
            <section className="w-full mt-8">
              <h3 className="text-2xl font-semibold mb-4 text-primary text-center">Planes y funcionalidades</h3>
            </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="border rounded-lg p-6 bg-card flex flex-col justify-between min-h-[220px]">
                ...
                <span className="font-bold text-green-600">$(...)/mes</span>
              </div>
            </div>
            <Button type="submit" className="w-full h-12 text-base font-semibold bg-primary text-white mt-8">Crear empresa</Button>
            {success && <p className="text-green-600 mt-4 font-semibold">¡Empresa registrada con éxito!</p>}
          </form>
          <Button
            variant="outline"
